...
<template>
  <div class="aside-nav-wrapper">
    <VPLink class="link" no-icon href="https://github.com/CN-E-Learning/CN-e-learning">
      <span class="vpi-github-star" />
      <span class="link-text">{{ locale.star }}</span>
      <span class="vpi-arrow-right" />
    </VPLink>
    <VPLink class="link" no-icon href="https://github.com/CN-E-Learning/CN-e-learning/issues/new/choose">
